...
$query = "SELECT * FROM flights WHERE toadd='$uh'";
if($query_run= mysql_query($query)){
	...
	$air=$query_row['air'];
		...
		echo "<h4 class=\"na-input na-btn na-large na-light-grey na-left na-half \">". $tt.'    '.$fro. ' '.$cla.'        '.$air ."<input  type=\"radio\" name=\"ano\" value=$tt />".'<br>'."</h4>". '<br><br><br>';
...
<form id=\"details\" action=\"aira4.php\" method=\"POST\">
    <div style=\"display: none;\">
	<input  class=\"na-input na-border\"  type=\"text\" placeholder=\"DD MM YYYY\"  name=\"day\" value=$day >
	</div>


    <div id=\"Car\" class=\"na-container na-light-gray na-padding-16 myLink\">
     <div class=\"container na-half1 na-center \">  
  
    <h3> Enter Details of Passenger</h3>
	<fieldset>
 <input name=\"passno\" class=\"na-input na-border\" placeholder=\"Passport Number\" type=\"text\" name=\"i1\" tabindex=\"1\" required autofocus></fieldset>
	<fieldset>
 <input name=\"fulna\" class=\"na-input na-border\" placeholder=\"Full Name\" type=\"text\" name=\"i2\" tabindex=\"2\" id=\"i2\" required> </fieldset>
	 <fieldset>
 <input name=\"age\" class=\"na-input na-border\" placeholder=\"age\" type=\"number\" name=\"i3\" tabindex=\"3\" id=\"i3\" required> </fieldset>
	 <fieldset>
 <input name=\"ph\" class=\"na-input na-border\"placeholder=\"Phone No\" type=\"number\" name=\"i4\" tabindex=\"4\" id=\"i4\" required> </fieldset>
	 <fieldset>
 <input name=\"em\" class=\"na-input na-border\"placeholder=\"Email Id\" type=\"email\" name=\"i5\" tabindex=\"5\" id=\"i5\" required></fieldset>
	 <fieldset>
 <input name=\"ad\" class=\"na-input na-border\"placeholder=\"Address\" type=\"text\" name=\"i6\" tabindex=\"6\" id=\"i6\" required></fieldset>
	 <fieldset>
 <input name=\"con\" class=\"na-input na-border\"placeholder=\"Country\" type=\"text\" name=\"i7\" tabindex=\"7\" id=\"i7\" required> </fieldset>
	 <fieldset>
 <div class=\"na-row-padding-16 na-center  \">
      <button  name=\"fn\" class=\"na-btn na-large  na-bold na-orange na-center\" value=$uh type=\"submit\" id=\"contact-submit\" >Submit</button>
	  </fieldset>
  </div>
  </form>
</div>
